    ...
    const openAIResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "This app's users are primarily in Bulgaria and the Balkans. When you see shredded or crumbled white cheese and cannot tell the exact type, default to a brined white cheese (Bulgarian sirene / feta-style: roughly 260 kcal, 14g protein, 21g fat per 100g) rather than mozzarella, since that is the far more common white cheese in this region. Only assume mozzarella or another white cheese if it visibly looks melted, stretchy, or otherwise clearly not a brined/crumbly cheese.",
