...
export const REFERENCE_CLIPS: Partial<Record<PoseName, ReferenceClip>> = {
  ...
  splitSquatStatic: {
    ...
    notes: "Batch 23 stage 2: the bottom's front thigh 87 (82 before): the front knee 85, the clip's, with the rear knee 13 cm up. Floor fix (clip audit): the rear toe sat 0.02 under the floor line, lifting the whole figure 4.5 cm off the floor. The toe is on the line now; the rear knee comes to 9 cm at the bottom (was 13).",
  },
  walkingLunge: {
    videoId: "6wZoPedlpok",
    ...
    notes: "Batch 23 stage 2: the bottom's front thigh is the clip's 86 -- it was held at 78 so the rear knee cleared the floor, which the old long thigh made necessary; on the new split the knee is 70 (hers 62-70) and the rear knee 10 cm up, as before. Floor fix (clip audit): the rear toe sat 0.02 under the floor line, and the ground, pinned to the lowest point, lifted the whole figure 4.5 cm: both feet floated. The toe is on the line now; the rear knee comes to 6 cm at the bottom (was 10), nearer the clip's just off the floor.",
  },
  legPress: {
    videoId: "B8KqmwdomoU",
