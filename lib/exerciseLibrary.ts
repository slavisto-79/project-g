...
export const exerciseLibrary: LibraryExercise[] = [
  ...
  { name: "Frog Pump", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.4, cue: "Soles of the feet together, knees wide, pulse the hips up." },
