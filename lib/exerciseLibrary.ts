...
export type LibraryExercise = {
  ...
  // Single-joint work. Not a lesser exercise -- a different job. Isolation gets
  // its own slots at the end of a session rather than competing with squats
  // and presses for the compound ones, which it always lost.
  isolation?: boolean;
...
export const exerciseLibrary: LibraryExercise[] = [
  ...
  { name: "Glute Bridge", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.4, cue: "Shoulders and feet on the floor, lift the hips, squeeze at the top." },
  { name: "Single-Leg Glute Bridge", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "beginner", unilateral: true, injurySafe: SAFE_ALL, bodyweightFraction: 0.45, cue: "One foot down, the other leg straight up. Lift with the working glute." },
  ...
  { name: "Cable Pull-Through", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: GYM_ONLY, implement: "cable", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 20, cue: "Face away from the stack, hinge back, stand and squeeze the glutes." },
  { name: "Cable Kickback", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: GYM_ONLY, implement: "cable", difficulty: "novice", unilateral: true, injurySafe: SAFE_ALL, startingKg: 8, cue: "Cuff on the ankle, hands on the frame. Drive the heel back, no arching." },
  { name: "Standing Hip Abduction", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ["gym", "home-gym", "minimal"], implement: "band", difficulty: "novice", unilateral: true, injurySafe: SAFE_ALL, cue: "Band round both ankles. Lift the leg out to the side, toes forward." },
  { name: "Banded Lateral Walk", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ["gym", "home-gym", "minimal"], implement: "band", difficulty: "beginner", goals: ["fitness", "athletic"], injurySafe: SAFE_ALL, cue: "Half squat, band above the ankles. Step wide, keep the tension on." },
  { name: "Back Extension", pattern: "hinge", primaryMuscle: "hamstrings", isolation: true, tiers: GYM_ONLY, implement: "machine", difficulty: "novice", injurySafe: BACK_HEAVY, bodyweightFraction: 0.45, cue: "Hinge over the pad and return to a straight line, no further." },
  { name: "Nordic Hamstring Curl", pattern: "hinge", primaryMuscle: "hamstrings", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "advanced", goals: ["athletic", "strength"], injurySafe: SAFE_ALL, bodyweightFraction: 0.6, cue: "Ankles anchored, lower your torso forward as slowly as you can." },
  { name: "Lying Leg Curl", pattern: "hinge", primaryMuscle: "hamstrings", isolation: true, tiers: GYM_ONLY, implement: "machine", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 20, cue: "Curl the heels toward the glutes without the hips lifting." },
  ...
  { name: "Hip Hinge Wall Touch", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.4, cue: "Stand a foot from a wall, push the hips back to touch it. Teaches the hinge." },
  { name: "Frog Pump", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.4, cue: "Soles of the feet together, knees wide. Drive the hips up, squeeze, lower under control." },
  { name: "Seated Leg Curl", pattern: "hinge", primaryMuscle: "hamstrings", isolation: true, tiers: GYM_ONLY, implement: "machine", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 25, cue: "Same curl, seated, which biases the lower hamstring." },
  ...
  { name: "Diamond Push-Up", pattern: "push", primaryMuscle: "triceps", tiers: ALL_TIERS, implement: "bodyweight", difficulty: "intermediate", injurySafe: SAFE_ALL, bodyweightFraction: 0.64, cue: "Hands together under the chest, elbows travelling back toward the feet." },
  ...
  { name: "Seated Dumbbell Press", pattern: "push", primaryMuscle: "shoulders", tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", perHand: true, injurySafe: SHOULDER_HEAVY, startingKg: 10, cue: "Sit tall on the bench. Press from the shoulders to straight arms overhead." },
  ...
  { name: "Straight-Arm Pulldown", pattern: "pull", primaryMuscle: "back", isolation: true, tiers: GYM_ONLY, implement: "cable", difficulty: "beginner", injurySafe: SAFE_ALL, startingKg: 15, cue: "Arms locked straight, sweep the bar down to the thighs." },
  ...
  { name: "Face Pull", pattern: "pull", primaryMuscle: "shoulders", isolation: true, tiers: ["gym", "minimal"], implement: "cable", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 15, cue: "Pull to the face with high elbows. The one everybody skips and shouldn't." },
  ...
  { name: "Prone Y-T-W Raise", pattern: "pull", primaryMuscle: "shoulders", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.15, cue: "Face down, lift the arms in a Y, then a T, then a W. Small range, real work." },
  { name: "Superman", pattern: "pull", primaryMuscle: "back", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.25, cue: "Face down, lift the chest and thighs off the floor together." },
  { name: "Reverse Snow Angel", pattern: "pull", primaryMuscle: "shoulders", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.15, cue: "Face down, arms sweeping from the hips to overhead without touching down." },
  { name: "Dumbbell Reverse Fly", pattern: "pull", primaryMuscle: "shoulders", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", perHand: true, injurySafe: SAFE_ALL, startingKg: 5, cue: "Hinged over, sweep the arms out and back with soft elbows." },

  // --- ARMS ----------------------------------------------------------------
  { name: "Barbell Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: FREE_WEIGHT, implement: "barbell", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 15, cue: "Elbows pinned to the ribs, no swinging from the hips." },
  { name: "Dumbbell Biceps Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", perHand: true, injurySafe: SAFE_ALL, startingKg: 8, cue: "Curl and lower slowly; the lowering is where most of the work is." },
  { name: "Hammer Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", perHand: true, injurySafe: SAFE_ALL, startingKg: 8, cue: "Palms facing each other throughout, which brings in the forearm." },
  { name: "Incline Dumbbell Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "beginner", perHand: true, injurySafe: SAFE_ALL, startingKg: 6, cue: "Lying back on an incline, arms hanging behind the torso." },
  { name: "Preacher Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: ["gym", "home-gym"], implement: "barbell", difficulty: "beginner", injurySafe: SAFE_ALL, startingKg: 12, cue: "Upper arms on the pad, no cheating from the shoulder." },
  { name: "Cable Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: GYM_ONLY, implement: "cable", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 15, cue: "Constant tension top to bottom." },
  { name: "Concentration Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", unilateral: true, perHand: true, injurySafe: SAFE_ALL, startingKg: 6, cue: "Seated, elbow braced on the inner thigh." },
  { name: "Band Curl", pattern: "pull", primaryMuscle: "biceps", isolation: true, tiers: ["minimal"], implement: "band", difficulty: "novice", injurySafe: SAFE_ALL, cue: "Stand on the band, curl against tension that grows near the top." },
  { name: "Triceps Pushdown", pattern: "push", primaryMuscle: "triceps", isolation: true, tiers: GYM_ONLY, implement: "cable", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 20, cue: "Elbows fixed at the ribs, straighten the arms fully." },
  { name: "Overhead Triceps Extension", pattern: "push", primaryMuscle: "triceps", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "beginner", injurySafe: SHOULDER_HEAVY, startingKg: 10, cue: "One bell behind the head, elbows pointing forward." },
  { name: "Skull Crusher", pattern: "push", primaryMuscle: "triceps", isolation: true, tiers: FREE_WEIGHT, implement: "barbell", difficulty: "intermediate", injurySafe: SAFE_ALL, startingKg: 15, cue: "Lying down, lower to the forehead, straighten without moving the elbows." },
  ...
  { name: "Triceps Kickback", pattern: "push", primaryMuscle: "triceps", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", unilateral: true, perHand: true, injurySafe: SAFE_ALL, startingKg: 5, cue: "Hinged over, upper arm still, straighten the elbow behind you." },
  ...
  // --- CALVES --------------------------------------------------------------
  { name: "Bodyweight Calf Raise", pattern: "push", primaryMuscle: "calves", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "novice", injurySafe: SAFE_ALL, bodyweightFraction: 0.9, cue: "Rise onto the toes, pause at the top, lower slowly." },
  { name: "Single-Leg Calf Raise", pattern: "push", primaryMuscle: "calves", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "beginner", unilateral: true, injurySafe: SAFE_ALL, bodyweightFraction: 0.9, cue: "One leg at a time, which roughly doubles the load." },
  { name: "Dumbbell Calf Raise", pattern: "push", primaryMuscle: "calves", isolation: true, tiers: DUMBBELL_TIERS, implement: "dumbbell", difficulty: "novice", perHand: true, injurySafe: SAFE_ALL, startingKg: 12, cue: "Holding dumbbells at the sides, rise onto the toes." },
  { name: "Seated Calf Raise", pattern: "push", primaryMuscle: "calves", isolation: true, tiers: GYM_ONLY, implement: "machine", difficulty: "novice", injurySafe: SAFE_ALL, startingKg: 20, cue: "Knees bent, which shifts the work to the deeper calf muscle." },
