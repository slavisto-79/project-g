...
export const exerciseLibrary: LibraryExercise[] = [
  ...
  { name: "Single-Leg Glute Bridge", pattern: "hinge", primaryMuscle: "glutes", isolation: true, tiers: ALL_TIERS, implement: "bodyweight", difficulty: "beginner", unilateral: true, injurySafe: SAFE_ALL, bodyweightFraction: 0.45, cue: "One foot down, the other knee pulled in, lift with the working glute." },
